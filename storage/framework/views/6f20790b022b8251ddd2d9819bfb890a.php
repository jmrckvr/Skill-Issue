...
<body class="bg-white">
    ...
    <div class="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-20 md:py-32 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            <!-- Search Bar -->
            <form action="<?php echo e(route('jobs.search')); ?>" method="GET" class="max-w-5xl mx-auto">
                <div class="space-y-6">
                    ...
                    <div class="text-right">
                        <a href="<?php echo e(route('jobs.search')); ?>" class="text-blue-200 hover:text-white font-medium text-sm transition duration-300 inline-flex items-center gap-1">
                            More options 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-bold text-blue-600 mb-2"><?php echo e($totalJobs); ?></div>
                    <p class="text-gray-600 font-medium">Active Job Listings</p>
                </div>
                <div class="text-center">
                    <div class="text-5xl md:text-6xl font-bold text-purple-600 mb-2"><?php echo e($totalCompanies); ?></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('jobs.search', ['category' => $category->id])); ?>" 
                        ...
                        <div class="text-4xl mb-3"><?php echo e($category->icon ?? '💼'); ?></div>
                        <p class="font-semibold text-gray-900 text-sm md:text-base"><?php echo e($category->name); ?></p>
                        <p class="text-xs md:text-sm text-gray-500 mt-2 font-medium"><?php echo e($category->job_count); ?> <?php echo e($category->job_count === 1 ? 'job' : 'jobs'); ?></p>
                    </a>
    ...
    <div class="py-16 md:py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
                ...
                <a href="<?php echo e(route('jobs.search')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold inline-flex items-center gap-2">
                    View all jobs
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $latestJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <a href="javascript:void(0)" class="job-card-link block" data-job-id="<?php echo e($job->id); ?>" style="text-decoration: none; color: inherit;">
                        <?php if (isset($component)) { $__componentOriginal6f52d5af15b7c5539df4e18d49b854b0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6f52d5af15b7c5539df4e18d49b854b0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cards.job-card','data' => ['job' => $job,'sidebar' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cards.job-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['job' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($job),'sidebar' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6f52d5af15b7c5539df4e18d49b854b0)): ?>
<?php $attributes = $__attributesOriginal6f52d5af15b7c5539df4e18d49b854b0; ?>
<?php unset($__attributesOriginal6f52d5af15b7c5539df4e18d49b854b0); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal6f52d5af15b7c5539df4e18d49b854b0)): ?>
<?php $component = $__componentOriginal6f52d5af15b7c5539df4e18d49b854b0; ?>
<?php unset($__componentOriginal6f52d5af15b7c5539df4e18d49b854b0); ?>
<?php endif; ?>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('jobs.search')); ?>" class="px-8 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition transform hover:scale-105">
                    Browse Jobs
                </a>
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-3 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition transform hover:scale-105">
                        Create Free Account
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH C:\Users\jmrck\Project Folder\Skill1ssue\jobstreet\resources\views/home.blade.php ENDPATH**/ ?>