    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow mb-8">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.users')); ?>" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    <p class="font-medium text-gray-900">Manage Users</p>
                    <p class="text-sm text-gray-600 mt-1">View, search, and deactivate users</p>
                </a>
                <a href="<?php echo e(route('admin.jobs')); ?>" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                ...
                <a href="<?php echo e(route('admin.categories')); ?>" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                    <p class="font-medium text-gray-900">Categories</p>
                    <p class="text-sm text-gray-600 mt-1">Add, edit, or remove job categories</p>
                </a>
                <a href="<?php echo e(route('admin.categories.create')); ?>" class="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
