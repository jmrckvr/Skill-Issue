...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="text-center text-sm mb-6">
                    <a href="<?php echo e(route('password.request')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold">
            ...
            <div class="mt-6 text-center">
                <p class="text-gray-700">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-800 font-semibold">
                        Create one now
                    </a>
                </p>
            </div>
...
<?php /**PATH C:\Users\jmrck\Project Folder\Skill1ssue\jobstreet\resources\views/auth/login.blade.php ENDPATH**/ ?>