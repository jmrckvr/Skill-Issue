                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-shrink-0">
                                            <?php if($thread->company->logo_path): ?>
                                                <?php if(str_starts_with($thread->company->logo_path, 'http')): ?>
                                                    <img src="<?php echo e($thread->company->logo_path); ?>" 
                                                         alt="<?php echo e($thread->company->name); ?>"
                                                         class="w-12 h-12 rounded-full object-cover bg-gradient-to-br from-blue-400 to-blue-600">
                                                <?php elseif(str_starts_with($thread->company->logo_path, 'logos/')): ?>
                                                    <img src="<?php echo e(asset($thread->company->logo_path)); ?>" 
                                                         alt="<?php echo e($thread->company->name); ?>"
                                                         class="w-12 h-12 rounded-full object-cover bg-gradient-to-br from-blue-400 to-blue-600">
                                                <?php else: ?>
