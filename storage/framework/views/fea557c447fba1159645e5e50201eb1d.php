...
<head>
    ...
    <title>Apply for <?php echo e($job->title); ?> - JobStreet</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <!-- Back Button -->
        <a href="<?php echo e(route('jobs.show', $job)); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-semibold mb-6 inline-block">← Back to Job</a>

        <div class="bg-white rounded-lg shadow-lg p-8">
            <!-- Job Header -->
            <div class="border-b border-gray-200 pb-6 mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Apply for this job</h1>
                <h2 class="text-2xl font-semibold text-gray-700 mb-2"><?php echo e($job->title); ?></h2>
                <p class="text-lg text-gray-600"><?php echo e($job->company->name); ?> • <?php echo e($job->location); ?></p>
            ...
            <div>
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <?php if($job->company->description): ?>
                        <p class="text-gray-600 text-sm mb-4"><?php echo e($job->company->description); ?></p>
                    <?php endif; ?>

                    <div class="space-y-2 text-sm text-gray-600">
                        <?php if($job->company->industry): ?>
                            <p><span class="font-semibold">Industry:</span> <?php echo e($job->company->industry); ?></p>
                        <?php endif; ?>
                        <?php if($job->company->employee_count): ?>
                            <p><span class="font-semibold">Size:</span> <?php echo e($job->company->employee_count); ?> employees</p>
                        <?php endif; ?>
                        <?php if($job->company->website): ?>
                            <p><span class="font-semibold">Website:</span> <a href="<?php echo e($job->company->website); ?>" target="_blank" class="text-blue-600 hover:text-blue-800">Visit</a></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
