    ...
    <div style="background: linear-gradient(135deg, #1e40af 0%, #1e3a8a 100%); color: white; padding: 80px 20px; text-align: center; margin: 0;">
        <div class="container">
            ...
            <div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
                <a href="{{ route('register-employer') }}" style="background: #ec4899; color: white; padding: 16px 32px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block; transition: all 0.3s;">
                    Create Account
                </a>
                <a href="{{ route('login') }}" style="background: white; color: #1e40af; padding: 16px 32px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block; transition: all 0.3s;">
                    Sign In
                </a>
            </div>
        </div>
    ...
    <div style="padding: 80px 20px; background: white;">
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 50px;">
                <a href="{{ route('register-employer') }}" style="background: #2563eb; color: white; padding: 16px 40px; border-radius: 8px; font-weight: bold; text-decoration: none; display: inline-block; font-size: 16px; transition: all 0.3s;">
