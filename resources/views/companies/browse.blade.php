...
<body class="bg-white">
    ...
    <div class="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white py-16 md:py-24 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
            ...
            <!-- Search Bar -->
            <form action="{{ route('companies.browse') }}" method="GET" class="mt-12 max-w-3xl">
            ...
            @if(request()->anyFilled(['keyword', 'location']))
                <div class="mt-4">
                    <a href="{{ route('companies.browse') }}" class="text-blue-200 hover:text-white font-medium text-sm transition duration-300 inline-flex items-center gap-1">
                        Clear filters
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($companies->count() > 0)
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
                    @foreach($companies as $company)
                        <a href="{{ route('jobs.search', ['company' => $company->id]) }}" class="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer block" style="text-decoration: none; color: inherit;">
                            ...
                            <div class="p-6 bg-gradient-to-br from-gray-50 to-gray-100 border-b border-gray-200">
                                <div class="flex justify-center mb-4 h-20">
                                    ...
                                    <div class="logo-container flex justify-center items-center h-20 w-20 mx-auto">
                                        @if($logoUrl)
                                            <img src="{{ $logoUrl }}" alt="{{ $company->name }}" class="max-h-20 max-w-full object-contain company-logo" data-company-id="{{ $company->id }}" loading="lazy" decoding="async">
                                        @else
            ...
            @else
                ...
                <div class="text-center py-16">
                    ...
                    <a href="{{ route('companies.browse') }}" class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">
                        View all companies
                    </a>
                </div>
            @endif
