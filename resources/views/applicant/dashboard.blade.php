    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
                ...
                @if($user->facebook_url || $user->github_url || $user->instagram_url)
                    <div class="bg-white rounded-lg shadow p-6 mt-8">
                        ...
                        <div class="space-y-3">
                            @if($user->facebook_url)
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ $user->facebook_url }}" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-700 font-medium truncate">
                                        Facebook Profile
                                    </a>
                                </div>
                            @endif
                            @if($user->github_url)
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ $user->github_url }}" target="_blank" rel="noopener noreferrer" class="text-gray-800 hover:text-gray-900 font-medium truncate">
                                        GitHub Profile
                                    </a>
                                </div>
                            @endif
                            @if($user->instagram_url)
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="{{ $user->instagram_url }}" target="_blank" rel="noopener noreferrer" class="text-pink-600 hover:text-pink-700 font-medium truncate">
                                        Instagram Profile
                                    </a>
                                </div>
                            @endif
