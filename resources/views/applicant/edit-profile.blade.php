    ...
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Form -->
                <form method="POST" action="{{ route('applicant.update-profile') }}" enctype="multipart/form-data" class="bg-white rounded-lg border border-gray-200 p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <script>
                        document.getElementById('profilePictureInput').addEventListener('change', function() {
                            if (this.files.length > 0) {
                                ...
                                fetch('{{ route("applicant.upload-picture") }}', {
                                    method: 'POST',
                                    body: formData
                                }).then(response => {
                                    if (response.ok) {
